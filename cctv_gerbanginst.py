    ...
    for frame_idx, (path, img, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
                ...
                if len(outputs) > 0:
                    ...
                    for j, (output, conf) in enumerate(zip(outputs, confs)):
                        ...
                        if names[c] == 'person' :
                            ...
                            # if int(output[1]+(output[3]-output[1])/2) > (120) and int(output[1]+(output[3]-output[1])/2) < (220) and int(output[0]+(output[2]-output[0])/2) < (340) and int(output[0]+(output[2]-output[0])/2) > (230):    
            ...
            if show_vid:
                ...
                # start_point = (230, 120)
                # end_point = (340, 120)
                # start_point1 = (230, 220)
                # end_point1 = (340, 220)
                # start_point2 = (230, 120)
                # end_point2 = (230, 220)
                # start_point3 = (340, 120)
                # end_point3 = (340, 220)
                # cv2.rectangle(im0,(340,220), (230, 115), color, 3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str,
                        default='videos/dataset5.mkv', help='source')
